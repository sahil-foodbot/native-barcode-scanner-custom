...
function _enventHandler (options, key) {
 ...
 */
  ...
  async initHandler() {
    events.on('key.pressed', this._enventHandler);
  }
 ...
 */
  ...
  async off() {
    events.removeListener('key.pressed',  this._enventHandler);
  }
